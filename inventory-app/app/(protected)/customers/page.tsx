...
export default async function CustomersPage({ searchParams }: { searchParams: Params }) {
  ...
  return <div className="operations-page domain-customers max-w-6xl"><PageHeader domain="customers" title="Customers" subtitle="Global customer and fleet master data" actions={hasPermission(access, 'customers.create') ? <Link href="/customers/new" prefetch={false} className="flex h-10 items-center rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground">New customer</Link> : null} />
