...
const vehiclePayload=(form:FormData)=>({vehicle_type:value(form,'vehicle_type'),registration:value(form,'registration')||null,fleet_number:value(form,'fleet_number')||null,make:value(form,'make')||null,model:value(form,'model')||null,year:value(form,'year')?Number(value(form,'year')):null,vin:value(form,'vin')||null,body_description:value(form,'body_description')||null,axle_configuration_notes:value(form,'axle_configuration_notes')||null,tyre_notes:value(form,'tyre_notes')||null,notes:value(form,'notes')||null});
