...
beforeAll(async () => {
  const variants: Record<string, InvoiceDocumentData> = {
    ...
    '247-supplied-logo': { ...invoice10602Fixture, business: { ...invoice10602Fixture.business, logo_asset_path: '/brand/logo-247-invoice-2026.png' } },
...
describe('invoice PDF brand routing', () => {
  it('embeds the supplied 24/7 logo only for the 24/7 asset path', () => {
    ...
    expect(rendered['247-supplied-logo']!.length).toBeGreaterThan(rendered['247-existing-template']!.length + 10_000);
  });
