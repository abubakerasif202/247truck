...
export const invoice10602Fixture: InvoiceDocumentData = {
  ...
  customerReference: null, customerNotes: null, extraDescription: null, discount: '0.00',
  ...
  lines: [
    { id: '1', description: 'Greforce HD02 11R 22.5 Drive', quantity: '8', unitPrice: '390.00', discountPercent: '0', discountAmount: '0.00', gstAmount: '312.00', amount: '3120.00', total: '3432.00', torqueNm: null, tyre: { brand: 'Greforce', model: 'HD02', size: '11R 22.5', position: 'Drive', quantity_fitted: 8 } },
    { id: '2', description: 'Steers rotation', quantity: '2', unitPrice: '20.00', discountPercent: '0', discountAmount: '0.00', gstAmount: '4.00', amount: '40.00', total: '44.00', torqueNm: null },
  ],
