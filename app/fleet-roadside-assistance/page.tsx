...
const title = "Fleet Roadside Assistance Registration";
...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: `${SITE_URL}/fleet-roadside-assistance`, images: [{ url: "/og.webp", width: 1200, height: 630, alt: "Commercial fleet roadside assistance registration" }] },
