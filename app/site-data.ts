...
export const detailPages: Record<string, DetailPage> = {
  services: {
    ...
    image: "/images/workshop-truck.jpg",
  ...
  "24-7-truck-tyre-assistance": {
    ...
    image: "/images/roadside-truck.jpg",
  ...
  "fleet-tyre-services": {
    ...
    image: "/images/australian-truck.jpg",
